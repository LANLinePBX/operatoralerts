...
7) Paste the contents of send_discord.sh from this repository into the file.
8) Update the webhook URL and Discord role ID variables with your own details, and customize the embed footer if desired.
